...
def test_addition():
    ...
    assert simple_calculator("add", 1, 2.2) == pytest.approx(3.2)    # Test for floating point
...
def test_subtraction():
    ...
    assert simple_calculator("subtract", 1, 2.2) == pytest.approx(-1.2) # Test for floating point
...
def test_multiplication():
    ...
    assert simple_calculator("multiply", 1, 1.1) == pytest.approx(1.1) # Test for float
...
def test_division():
    ...
    assert simple_calculator("divide", 5, 2) == pytest.approx(2.5)     # Test for division resulting in float
